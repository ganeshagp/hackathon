...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2021 at 01:08 PM
...
(1, 'blogs', 'posts', 'title', '', 'text_plain', '', '', '', ''),
(2, 'blogs', 'posts', 'short_description', '', 'text_plain', '', '', '', ''),
(3, 'blogs', 'posts', 'full_description', '', 'text_plain', '', '', '', ''),
(4, 'blogs', 'posts', 'author', '', 'text_plain', '', '', '', '');
...
('root', '[{\"db\":\"blogs\",\"table\":\"contacts\"},{\"db\":\"blogs\",\"table\":\"posts\"}]');
...
('root', '2021-12-16 12:07:26', '{\"Console\\/Mode\":\"collapse\"}');
